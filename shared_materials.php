<?php
    ...
    $db = new DB_Handler();
    $materials = $db->get_shared_materials($_SESSION['user']->getOid());
                    ...
                    <div class="card-body">
                        ...
                        <div class="row no-gutters">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <button type="button" onclick="view_material(0,'<?php echo $m['oid']; ?>');" class="btn btn-secondary btn-sm float-lg-right float-md-right" style="margin: 2px 5px;" >Visualizar</button>    
                            </div>
                        </div>
                    </div>
                </div>
